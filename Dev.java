...
public class Dev {
 ...
 Developer.println();
 Developer.println(55);
 Developer.println("Kishore");
 Developer.println(false);
 Developer.max(56,23);
 Developer.max(56,23,53);
 Developer.max('S','s');
 Developer.palindromeOrNot(12321);
 Developer.palindromeOrNot(2325);
 Developer.palindromeOrNot("Kissu");
 Developer.palindromeOrNot("nun");
 }
}
